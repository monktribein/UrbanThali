      ...
      <header style={{ margin: 0, padding: 0 }}>
        ...
        >
          ...
          >
            ...
            {/* Action Buttons */}
            <div
              className="tp-header-action d-flex align-items-center"
              style={{
                gap: '8px',
                flex: '0 0 auto',
                minWidth: '100px',
            ...
            >
              ...
              {/* User Dropdown */}
              <div
                className="tp-header-action-item d-none d-sm-block"
                style={{ display: 'flex', alignItems: 'center' }}
              >
                <UserDropdown />
              </div>
              ...
              {/* Mobile Menu Button */}
              <div
                className="tp-header-action-item d-lg-none"
                style={{ display: 'flex', alignItems: 'center' }}
              >
                <button
